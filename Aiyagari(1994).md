...
$$c_t \ge 0$$
$$ a_t > - b $$
where <img src="https://render.githubusercontent.com/render/math?math=b"> $b$ (if positive) is the limit on borrowing and $y_t$ is assumed to be iid with bounded support given by $\left[y_{min}, y_{max}\right]$ with $y_{min} > 0$.
